...
from main.views.main.index import index, terms_of_use , privacy_policy, history, delete_expense, delete_income, delete_multiple_transactions, post_expense, post_income, profile_view,change_password_view,edit_profile_view
